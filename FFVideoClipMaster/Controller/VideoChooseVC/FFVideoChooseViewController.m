...
-(UICollectionView *)collectionView{
    if (!_collectionView) {
        ...
        _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 64,ViewSize(self.view).width, ViewSize(self.view).height) collectionViewLayout:flowLayout];
