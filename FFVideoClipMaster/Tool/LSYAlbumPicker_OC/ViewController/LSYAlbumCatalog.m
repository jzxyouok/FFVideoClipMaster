...
- (void)setMaximumNumberOfSelectionVideo:(NSInteger)maximumNumberOfSelectionVideo{
    _maximumNumberOfSelectionMedia = maximumNumberOfSelectionVideo;
    [LSYAlbum sharedAlbum].assstsFilter = [ALAssetsFilter allVideos];
}
/*
